...
print("""This is a simple python script that I made to follow red checkpoints in FiveM admin jail.
Starting in 5 sec...
Recommended settings: 1920x1080 display size, 3rd perso view: 2, game: night
""", flush=True)
time.sleep(5)
print("")
